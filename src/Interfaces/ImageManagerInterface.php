...
interface ImageManagerInterface
{
     ...
     *
     * @link https://image.Kanhaiyanigam05.io/v3/basics/instantiation#create-new-images
     *
     ...
     * - Data Uri
     * - Kanhaiyanigam05\Image\Image Instance
     *
     ...
     * a selection of classes of the namespace `Kanhaiyanigam05\Image\Decoders`
     *
     * If the second parameter is not set, an attempt to decode the input is made
     * with all available decoders of the driver.
     *
     * @link https://image.Kanhaiyanigam05.io/v3/basics/instantiation#read-image-sources
     *
     ...
     *
     * @link https://image.Kanhaiyanigam05.io/v3/basics/instantiation#create-animations
     *
     * @throws RuntimeException
     */
